    ...
    <div className="bg-gradient-to-b from-white via-slate-50 to-[#F0FF96]/30">
      <section className="mx-auto max-w-5xl px-4 py-16 sm:py-20">
        ...
        <h1 className="mt-4 text-4xl font-bold text-slate-900 sm:text-5xl">
          Chi può aderire al programma TOEFL Ambassador
        </h1>
        <p className="mt-4 max-w-3xl text-lg text-slate-700">
          Il programma è aperto a organizzazioni che desiderano promuovere o offrire il TOEFL iBT® in modo ufficiale. La rete di ambassador copre diversi contesti formativi e professionali.
        </p>
