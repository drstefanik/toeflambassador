    ...
    <div className="bg-gradient-to-b from-white via-slate-50 to-[#F0FF96]/30">
      <section className="mx-auto max-w-5xl px-4 py-16 sm:py-20">
        ...
        <p className="mt-4 max-w-3xl text-lg text-slate-700">
          Un programma creato con ETS per dare alle sedi strumenti di comunicazione, formazione e supporto. Ogni centro può valorizzare il proprio ruolo locale mantenendo coerenza con il brand TOEFL®.
        </p>
