    ...
    <div className="bg-gradient-to-b from-white via-slate-50 to-[#F0FF96]/30">
      <section className="mx-auto max-w-5xl px-4 py-16 sm:py-20">
        ...
        <h1 className="mt-4 text-4xl font-bold text-slate-900 sm:text-5xl">
          Elenco centri TOEFL Ambassador
        </h1>
        <p className="mt-4 text-lg text-slate-700">
          Consulta i partner già attivi, scopri le città coperte e visita la
          pagina dedicata di ogni centro.
        </p>

        <div className="mt-10">
          <CentersDirectoryShell centers={points} />
        </div>
      </section>
    </div>
  );
